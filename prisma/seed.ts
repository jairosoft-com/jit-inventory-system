...
const ROLES = [
  ...
  { name: 'MANAGER', description: 'Operational authority — inventory and borrow management', isSystem: true },
...
const PERMISSIONS = [
  ...
  { name: 'inventory:delete', resource: 'inventory', action: 'delete', description: 'Delete/archive inventory items' },

  // Equipment
  { name: 'equipment:create', resource: 'equipment', action: 'create', description: 'Register equipment' },
  { name: 'equipment:read', resource: 'equipment', action: 'read', description: 'View equipment details' },
  { name: 'equipment:update', resource: 'equipment', action: 'update', description: 'Update equipment records' },
  { name: 'equipment:delete', resource: 'equipment', action: 'delete', description: 'Delete/archive equipment' },

  // Borrow
  { name: 'borrow:submit', resource: 'borrow', action: 'create', description: 'Submit borrow requests' },
  { name: 'borrow:approve', resource: 'borrow', action: 'approve', description: 'Approve/reject borrow requests' },
  { name: 'borrow:read', resource: 'borrow', action: 'read', description: 'View borrow records' },

  // Disposal
  { name: 'disposal:approve', resource: 'disposal', action: 'approve', description: 'Approve equipment disposal' },
  { name: 'disposal:read', resource: 'disposal', action: 'read', description: 'View disposal records' },

  // Users
  { name: 'users:manage', resource: 'users', action: 'create', description: 'Create and manage user accounts' },
  { name: 'users:read', resource: 'users', action: 'read', description: 'View user profiles' },

  // Roles & Permissions
  { name: 'roles:manage', resource: 'roles', action: 'update', description: 'Manage roles and permissions' },
  ...
  // Suppliers
  { name: 'suppliers:create', resource: 'suppliers', action: 'create', description: 'Create supplier records' },
  { name: 'suppliers:read', resource: 'suppliers', action: 'read', description: 'View supplier records' },
  { name: 'suppliers:update', resource: 'suppliers', action: 'update', description: 'Update supplier records' },

  // Purchase Orders
  { name: 'purchase_orders:create', resource: 'purchase_orders', action: 'create', description: 'Create purchase orders' },
  { name: 'purchase_orders:read', resource: 'purchase_orders', action: 'read', description: 'View purchase orders' },
  { name: 'purchase_orders:update', resource: 'purchase_orders', action: 'update', description: 'Update purchase orders' },

  // Stock Movement
  { name: 'stock_in:create', resource: 'stock_in', action: 'create', description: 'Record stock in' },
  { name: 'stock_out:create', resource: 'stock_out', action: 'create', description: 'Record stock out' },
  { name: 'stock:read', resource: 'stock', action: 'read', description: 'View stock movements' },

  // Maintenance
  { name: 'maintenance:create', resource: 'maintenance', action: 'create', description: 'Create maintenance logs' },
  { name: 'maintenance:read', resource: 'maintenance', action: 'read', description: 'View maintenance logs' },
  { name: 'maintenance:update', resource: 'maintenance', action: 'update', description: 'Update maintenance logs' },

  // Audit Logs
  { name: 'audit_logs:read', resource: 'audit_logs', action: 'read', description: 'View audit trail' },

  // Reports
  { name: 'reports:export', resource: 'reports', action: 'read', description: 'Generate and export reports' },
];
...
const ROLE_PERMISSION_MAP: Record<string, string[]> = {
  ADMIN: [
    ...
    'borrow:submit', 'borrow:approve', 'borrow:read',
    'disposal:approve', 'disposal:read',
    ...
    'stock_in:create', 'stock_out:create', 'stock:read',
