  ...
  return (
    <div className="dash-page animate-fade-in flex flex-col gap-6">
      ...
      <div className="dash-page-header">
        <div>
          <h1 className="dash-page-title">Users & Roles</h1>
          <p className="dash-page-desc">
            Manage team members and their access to company inventory          </p>
        </div>
                    ...
                    <tr key={user.id} className="transition hover:bg-[var(--surface-hover)]">
                      ...
                      {canManageUserAccess && (
                        <td className="px-4 py-3">
                          {isSuperAdmin(user) ? (
                            <span
                              className="inline-flex items-center gap-1 rounded-full bg-[var(--background-tertiary)] px-2.5 py-1 text-xs font-medium text-[var(--text-tertiary)]"
              ...
              {filteredUsers.map((user) => (
                ...
                >
                  ...
                  {canManageUserAccess &&
                    (isSuperAdmin(user) ? (
                      <span
                        className="mt-4 inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-[var(--background-tertiary)] px-3 py-2 text-xs font-medium text-[var(--text-tertiary)]"
                        title="Superadmin — protected"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
